...
embedder = FastTextEmbeddingLayer(dim_emb)

shown_embeded = embedder.forward(articles_shown_npy)

with open('user_history_emb.npy', 'wb') as f:
    np.save(f,shown_embeded)


raise Exception('for now it is done')
return 
